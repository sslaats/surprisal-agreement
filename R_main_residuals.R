...
# load data 
data <- read.csv('K:/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/readingtimes_88pp_preprocessed.csv', header = TRUE)
...
write.csv(data, 'K:/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/readingtimes_88pp_residuals_manual.csv')
