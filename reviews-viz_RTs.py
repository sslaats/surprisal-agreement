...
# %% load the new data
resultsdir = '//nasac-faculty.isis.unige.ch/MEDECINE_HOME_PAPAT/Neufo/slaats/MPI/Project 3 - Behavioural studies/Project 3 - Behavioural studies/3 - SPR main/analysis/'
RTs = pd.read_csv(f'{resultsdir}/readingtimes_88pp_residuals_manual-outliers-REVIEWS.csv')

def get_interval(x):
    return stats.norm.interval(confidence=0.95, loc=np.mean(x), scale=stats.sem(x))
...
sns.despine()
plt.tight_layout()
fig.savefig(f'{resultsdir}/88_pps_linRTs_confint_manual-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_linRTs_confint_manual-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_logRTs-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs-outliers-REVIEWS.svg')
...
sns.despine()
plt.tight_layout()
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_PLURALITY-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_PLURALITY-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_ungram-by-number-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_ungram-by-number-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_ungram-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_ungram-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_scatter_surprisal_agreement_interaction-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_scatter_surprisal_agreement_interaction-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_scatter_surprisal_agreement_separate-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_scatter_surprisal_agreement_separate-outliers-REVIEWS.svg')
...
ax[0,0].legend(['High surprisal', 'Low surprisal'], frameon=False, loc='upper right')
...
ax[0,1].legend(['Singular', 'Plural'], frameon=False, loc='upper right')
...
ax[1,0].legend(['Correct', 'Incorrect'], frameon=False, loc='upper right')
...
ax[1,1].legend(['Correct', 'Incorrect'], frameon=False, loc='upper right')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_line_interactions_pairwise-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_line_interactions_pairwise-outliers-REVIEWS.svg')
...
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_PLURALITY-N-outliers-REVIEWS.png', dpi=300)
fig.savefig(f'{resultsdir}/88_pps_resid_logRTs_confint_manual_PLURALITY-N-outliers-REVIEWS.svg')
