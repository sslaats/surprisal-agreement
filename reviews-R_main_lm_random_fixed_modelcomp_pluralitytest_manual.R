...
# largest non-singular model: "(1 + agreement | UserId)"
...
# agreement by number
emmeans(fixed5[[3]], specs='agreement', by='correct_number', pbkrtest.limit = 3510)
joint_tests(fixed5[[3]], by='correct_number', adjust='none', pbkrtest.limit = 3510)

# number by agreement
emmeans(fixed5[[3]], specs='correct_number', by='agreement',pbkrtest.limit = 3510)
joint_tests(fixed5[[3]], by='agreement', adjust='none', pbkrtest.limit = 3510)
...
# best model: random intercept "(1 + surprisal | UserId) - leads to singular fit of the models to be compared"
...
# agreement by number
emmeans(con_fixed5[[2]], specs='agreement', by='correct_number', pbkrtest.limit = 3600)
joint_tests(con_fixed5[[2]], by='correct_number', pbkrtest.limit = 3600, adjust='none')

# number by agreement
emmeans(con_fixed5[[2]], specs='correct_number', by='agreement', pbkrtest.limit = 3600)
joint_tests(con_fixed5[[2]], by='agreement', pbkrtest.limit = 3600, adjust='none')
...
# only effect that works (1 | UserId)
...
anova(con_fixed6[[1]], con_fixed6[[2]]) # Marginal. Reduce branch 1
...
# agreement by number
emmeans(con_fixed6[[2]], specs='agreement', by='correct_number',pbkrtest.limit = 3600)
joint_tests(con_fixed6[[2]], by='correct_number', pbkrtest.limit = 3600, adjust='none')

# number by agreement
emmeans(con_fixed6[[2]], specs='correct_number', by='agreement',pbkrtest.limit = 3600)
joint_tests(con_fixed6[[2]], by='agreement',pbkrtest.limit = 3600, adjust='none')
...
AIC(con_nonsingular7[[1]], con_nonsingular7[[2]])

# random slopes for surprisal and agreement
...
anova(con_fixed8[[7]], con_fixed8[[11]]) # correct_number can go
