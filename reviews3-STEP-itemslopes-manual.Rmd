---
title: "reviews3_surprisal-agreement-itemslopes"
author: "S. Slaats"
date: "2025-11-24"
...
fixed_effects <- list('logRTresidual ~ agreement * surprisal_value + agreement * correct_number', # 1
                      'logRTresidual ~ surprisal_value + agreement * correct_number',             # 2
                      'logRTresidual ~ agreement * correct_number',                         # 3
                      'logRTresidual ~ agreement * surprisal_value + correct_number',             # 4
                      'logRTresidual ~ agreement * surprisal_value',                              # 5
                      'logRTresidual ~ surprisal_value + agreement + correct_number',             # 6
                      'logRTresidual ~ agreement + correct_number',                         # 7
                      'logRTresidual ~ surprisal_value + correct_number',                         # 8
                      'logRTresidual ~ surprisal_value + agreement',                              # 9
                      'logRTresidual ~ surprisal_value',                                          # 10
...
saveRDS(models5, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models5.Rdata')
```
...
saveRDS(models6, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models6.Rdata')
```
...
saveRDS(models7, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models7.Rdata')
```
...
saveRDS(models8, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models8.Rdata')
```
...
models5 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models5.Rdata')
...
fixed5 <- lapply(fixed_effects, fit_fixed, "(1 + agreement | set_number) + (1 + agreement | UserId)", subset(data, word_index==5))

# save the fixed models
saveRDS(fixed5, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/fixed5.Rdata')
...
summary(best_model5)
saveRDS(best_model5, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model5.Rdata')
```
#### Permutation test
```{r permutation5, include=TRUE, message=FALSE, warning=FALSE}
best_model5 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model5.Rdata')
perm5 <- permute_lmer(best_model5,
                      subset(data, word_index==5),
                      n_permutations,
                      verbose=TRUE)
saveRDS(perm5, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/perm55.Rdata')
```
...
models6 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models6.Rdata')
...
# save the fixed models
saveRDS(fixed6, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/fixed6.Rdata')
...
summary(best_model6)
saveRDS(best_model6, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model6.Rdata')
```
#### Permutation test
```{r permutation6, include=TRUE, message=FALSE, warning=FALSE}
# load the best model
best_model6 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model6.Rdata')
perm6 <- permute_lmer(best_model6,
                      subset(data, word_index==6),
                      n_permutations,
                      verbose=TRUE)
saveRDS(perm6, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/perm6.Rdata')
```
...
models7 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models7.Rdata')
...
# save the fixed models
saveRDS(fixed7, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/fixed7.Rdata')
...
summary(best_model7)
saveRDS(best_model7, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model7.Rdata')
```
#### Permutation test
```{r permutation7, include=TRUE, message=FALSE, warning=FALSE}
best_model7 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model7.Rdata')
perm7 <- permute_lmer(best_model7,
                      subset(data, word_index==7),
                      n_permutations,
                      verbose=TRUE)
saveRDS(perm7, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/perm7.Rdata')
```
...
models8 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/models8.Rdata')
...
# now we reduce the fixed effects - STEP keeps reducing random effects too
# so we go back to manual selection
fixed8 <- lapply(fixed_effects, fit_fixed, "  (1 + agreement | set_number) + (1 + agreement | UserId)", subset(data, word_index==8))

# save the fixed models
saveRDS(fixed8, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/fixed8.Rdata')
...
summary(best_model8)
saveRDS(best_model8, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model8.Rdata')
```

#### Permutation test
```{r word index 8 permutation, include=TRUE, message=FALSE, warning=FALSE}
best_model8 <- readRDS('C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/best_model8.Rdata')
perm8 <- permute_lmer(best_model8,
                      subset(data, word_index==8),
                      n_permutations,
                      verbose=TRUE)
saveRDS(perm8, file='C:/Users/slaats/Documents/MPI/Project/Project 3 - Behavioural studies/3 - SPR main/analysis/perm8.Rdata')

```

```{r word index 8 viz permutation, fig.width=5,fig.height=4, include=TRUE, message=FALSE, warning=FALSE}
